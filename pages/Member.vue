        ...
        <div>
          <template v-for="m in members" :key="m.id">
            ...
            <div class="grid grid-cols-[48px_1fr_1fr_1fr_1fr_1fr] items-center border-b last:border-b-0">
              ...
              <div class="h-14 flex items-center justify-center">{{ m.createby }}</div>
            </div>
...
const members = ref<Member[]>([
  { id: 1, memberId: '001', name: 'A', surname: 'AA', createby: "Navaphan 01/09/2025" },
  { id: 2, memberId: '002', name: 'B', surname: 'BB', createby: "Noyjinda 01/09/2025" },
])
