<template>
  <div class="container lg:mx-auto px-2 py-5 lg:px-5 lg:py-5">
    <h1 class="text-[20px]">Report > User Report</h1>
    ...
    <!-- ตารางอยู่ในการ์ด + scroll แนวนอน -->
    <div class="mt-6 bg-white rounded-2xl shadow-lg ring-1 ring-gray-200 overflow-hidden">
      <div class="overflow-x-auto [-webkit-overflow-scrolling:touch]">
        <div class="min-w-[900px] text-sm">
          <!-- หัวตาราง -->
...
function selectFilter(opt: FilterType) {
  ...
  // TODO: ใส่ logic กรองตารางของคุณตรงนี้
}
</script>

<style scoped>
/* เพิ่มสไตล์เฉพาะได้ตามต้องการ */
</style>
